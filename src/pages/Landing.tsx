...
import { Mic, FileText, Mail, Users, Clock, CheckCircle, Zap, Timer, ArrowRight, Smartphone } from "lucide-react";
...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-hero overflow-hidden">
      ...
      <div className="bg-deep-navy py-16 lg:py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-primary rounded-3xl mb-8 shadow-lg">
            ...
            <p className="text-lg sm:text-xl text-white/70 mb-12 max-w-2xl mx-auto leading-relaxed">
              Record meetings on the go, capture voice notes anywhere, and get instant reports 
              delivered to your inbox. Download the app for the full experience.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
              ...
              <a 
                ...
                className="group flex items-center gap-4 bg-white/10 hover:bg-white/20 border border-white/20 rounded-2xl px-6 py-4 transition-all duration-300 hover:scale-105 hover:shadow-lg w-full sm:w-auto"
              >
            ...
            <div className="flex flex-wrap gap-6 justify-center items-center text-sm text-white/60">
